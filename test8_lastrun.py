...
expName = 'test8'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Psychopy\\Tasks\\Nback\\test8_lastrun.py',
    ...
    for thisNb_trial in nb_trials:
        ...
        while continueRoutine and routineTimer.getTime() < 2.0:
            ...
            if corrAns == 'space' and (trialResp.keys == 'space'):
                ...
                send_the_code(100 + trialsNum + 10)
            ...
            if not(corrAns == 'space') and (trialResp.keys == 'space'):
                ...
                send_the_code(100 + trialsNum + 11)
